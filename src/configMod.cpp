...
Config load_config(const std::string& path) {
    ...
    set_number(values, "low_cs2_end_min", cfg.low_cs2_end_min);
    set_number(values, "low_cs2_end_max", cfg.low_cs2_end_max);
    ...
    if (cfg.low_cs2_end_min < cfg.cmin) {
        throw std::runtime_error("low_cs2_end_min must be >= cmin");
    }

    if (cfg.low_cs2_end_max > cfg.cmax) {
        throw std::runtime_error("low_cs2_end_max must be <= cmax");
    }

    if (cfg.low_cs2_end_max < cfg.low_cs2_end_min) {
        throw std::runtime_error("low_cs2_end_max must be >= low_cs2_end_min");
    }
